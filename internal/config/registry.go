...
func (cfg *registry) parseConfigValues() error {
	...
	authority, username, password, token :=
		os.Getenv("GRIFFON_REGISTRY_AUTH_AUTHORITY"),
		os.Getenv("GRIFFON_REGISTRY_AUTH_USERNAME"),
		os.Getenv("GRIFFON_REGISTRY_AUTH_PASSWORD"),
		os.Getenv("GRIFFON_REGISTRY_AUTH_TOKEN")
